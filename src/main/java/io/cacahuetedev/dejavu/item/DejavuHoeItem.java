...
public class DejavuHoeItem extends HoeItem implements IIdentifiable {
    Identifier id;

    protected DejavuHoeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
