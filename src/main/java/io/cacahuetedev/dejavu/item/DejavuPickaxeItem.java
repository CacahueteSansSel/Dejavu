...
public class DejavuPickaxeItem extends PickaxeItem implements IIdentifiable {
    Identifier id;

    protected DejavuPickaxeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
