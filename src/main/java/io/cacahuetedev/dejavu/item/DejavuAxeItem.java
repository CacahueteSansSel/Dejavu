...
public class DejavuAxeItem extends AxeItem implements IIdentifiable {
    Identifier id;

    protected DejavuAxeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
